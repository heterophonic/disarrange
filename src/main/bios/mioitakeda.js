...
const MioiTakeda = (props) => {
    return (
        <div className="eggshell">
            <h2>Mioi Takeda</h2>
            <Image src="/images/people/mioitakeda.jpg" size="small" floated="left"/>
            <p>
            Recognized for her "superb eloquence and purity of tone" in Fanfare, Japanese violinist Mioi Takeda earned her reputation as a soloist, chamber musician, orchestral player, and as a seasoned new music specialist in town. Ms. Takeda has performed with new music groups, including Miolina, North/South Consonance as concertmaster, SEM Ensemble, and Composers Concordance, giving countless premieres. She has also performed with the Orchestra of St. Luke's, American Symphony Orchestra, Washington Square Festival, Scandia Symphony, Stamford Symphony, Strathmere Orchestra, The Japan Philharmonic, and The New Japan Philharmonic. Ms. Takeda's performances can be heard on North/South and Naxos Recordings.
            </p>
            <p>
