...
const GenePritsker = (props) => {
    return (
        <div className="eggshell">
            <h2>Gene Pritsker</h2>
            <Image src="/images/people/genepritsker.webp" size="small" floated="left"/>
            <p>
            Composer/guitarist/rapper/Di.J./producer Gene Pritsker has written over 800 compositions, including chamber operas, orchestral and chamber works, electro-acoustic music and songs for hip-hop and rock ensembles. All of his compositions employ an eclectic spectrum of styles and are influenced by his studies of various musical cultures.  
            </p>
            <p>
            ...
            <p>See more info at <a href="https://www.genepritsker.com/" target="_blank">www.genepritsker.com</a></p>
        </div>
    )
}
export default GenePritsker